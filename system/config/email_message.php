...
$config[email_class::TYPE_QUESTION_SHARE] = array(
	'subject' => "[#user_name#] 在 [#site_name#] 分享了一个问题给你：[#question_title#]",
	'message' => "[#user_name#] 在 [#site_name#] 分享了一个问题给你：[#question_title#]",
);

$config[email_class::TYPE_ANSWER_SHARE] = array(
	'subject' => "[#user_name#] 在 [#site_name#] 分享了一个问题给你：[#question_title#]",
	'message' => "[#user_name#] 在 [#site_name#] 分享了一个问题给你：“[#question_title#]” [#answer_user#]：[#answer_content#]",
);

$config[email_class::TYPE_TOPIC_SHARE] = array(
	'subject' => "[#user_name#] 在 [#site_name#] 分享了一个话题给你：[#topic_title#]",
	'message' => "[#user_name#] 在 [#site_name#] 分享了一个话题给你：“[#topic_title#]”",
);
...
$config[email_class::TYPE_QUESTION_DEL] = array(
	...
	'message' => "您发表的问题 <<[#question_title#]>> 已被管理员删除。 <br/><br/>----- 所删除的内容 -----<br/><br/>[#question_detail#]<br/><br/>-----------------------------<br/><br/>如有任何疑问，请联系管理员，谢谢合作。",
);
