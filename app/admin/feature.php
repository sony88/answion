...
class feature extends AWS_CONTROLLER
{
	...
	public function list_action()
	{
		...
		$this->crumb("专题管理", "admin/feature/list/");
	...
	public function edit_action()
	{
		...
		$this->crumb('编辑专题', "admin/feature/list/");
	...
	public function topic_list_action()
	{
		...
		$this->crumb('管理专题：' . $feature['title'] . '  下的话题', "admin/feature/list/");
	...
	public function add_topic_ajax_action()
	{
		...
		{
			H::ajax_json_output(AWS_APP::RSM(null, -1, '话题已存在'));
		}
	}
	...
	{
		if($this->model('feature')->delete_feature($_GET['feature_id']))
		{
