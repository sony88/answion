(function(){
	if ($.browser.msie && $.browser.version == "6.0" && !$.support.style){
		...
		}).html('<p style="color:#888;padding-right:30px;padding-bottom:10px;">您的浏览器版本非常旧，存在诸多安全和体验问题! 建议<a href="http://windows.microsoft.com/zh-CN/internet-explorer/downloads/ie-9/worldwide-languages">更新</a>或者使用其他浏览器来访问, 如果您使用的是搜狗、360、遨游等双核浏览器，请切换到极速模式以获得更好的体验</p><p><a href="http://www.google.cn/intl/zh-CN/chrome/browser">￮ 谷歌浏览器</a></p><p><a href="http://j.union.ijinshan.com/jump.php?u_key=136711">￮ 猎豹浏览器</a></p><p><a href="http://firefox.com.cn">￮ Firefox 浏览器</a></p>')
