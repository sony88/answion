...
_ajax_uploader.FileUploader = function(o){
    ...
    _ajax_uploader.extend(this._options, {
        ...
        fileTemplate: '<li>' +
				...
				'<p class="_ajax_upload-inset"><a href="javascript:;" class="fr delect_file"  onclick="if (confirm(\'确认删除文件?\')) { _ajax_uploader_delete_attach(this.href, $(this).parent().parent()) } return false;" title="删除此附件">删除</a></p>' +
            '</li>',        
...
function _ajax_uploader_append_file(selecter, v)
{
    ...
    var html = '<li>' +
        ...
        '<p class="_ajax_upload-inset "><a href="' + v['delete_link'] + '" onclick="if (confirm(\'确认删除文件?\')) { _ajax_uploader_delete_attach(this.href, $(this).parent().parent()) } return false;" class="delect_file fr">删除</a>';
        
        if (typeof(v['thumb']) != 'undefined' && typeof(v['attach_id']) != 'undefined')
        {
	        html += '<a href="javascript:;" onclick="insert_attach(this, ' + v['attach_id'] + ',\'' + v['attach_tag'] + '\')">插入</a></p>';
        }else{
			html += '</p>';
		}
